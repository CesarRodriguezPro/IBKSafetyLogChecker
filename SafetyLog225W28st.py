...
LIST_LOCATIONS = '225'.split()
location_title = '225/215 W 28st '
############################################################
...
class CreatedReport:
    ...
    def body(self, ws, employees_list):
        ...
        ws['A37'] = square+ ' Safety of Concrete Pour'
    ...
    for location in LIST_LOCATIONS:
        try:
            ...
            try:
                ...
                try:
                    send_email(location, total_employees=total_employees)
                except:
                    print("there was a error sending Email.")
            except:
...
if __name__ == "__main__":
    ...
    for location in LIST_LOCATIONS:
        ...
        try:
            ...
            try:
                convert_to_pdf(location=location)  
                answer = input('Do you wanna send?')
                if answer[0].lower() == 'y':     
                    try:
